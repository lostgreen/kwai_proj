#!/usr/bin/env bash
# ============================================================
# EasyR1 - Qwen3-VL YouCook2 三层级混合 GRPO 训练脚本
# 数据：L1(macro) + L2(event) + L3(grounding) 各约 1/3 混合
# 配置：TP=2, 8卡, GRPO
# ============================================================
set -x
...
exp_name='qwen3_vl_youcook2_hier_mixed_L123_grpo'
...
VIDEO_FPS=2.0           # effective ~1fps after temporal_patch_size=2 merge
MAX_FRAMES=256
MAX_PIXELS=49152        # 32*32*48, qwen3 每帧 token 上限
MIN_PIXELS=3136
