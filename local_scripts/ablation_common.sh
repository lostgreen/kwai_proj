...
ABLATION_CHECKPOINT_ROOT="${ABLATION_CHECKPOINT_ROOT:-/m2v_intern/xuboshen/zgw/RL-Models/VideoProxyMixed/multi_task_8b_lr5e-7_kl0p01_entropy0p005_ablations}"
