...
OFFLINE_FRAME_ROOT="${OFFLINE_FRAME_ROOT:-${MULTI_TASK_DATA_ROOT}/offline_frames/${EXP_NAME}}"
TRAIN_FRAMES_ROOT="${TRAIN_FRAMES_ROOT:-${OFFLINE_FRAME_ROOT}/train}"
VAL_FRAMES_ROOT="${VAL_FRAMES_ROOT:-${OFFLINE_FRAME_ROOT}/val}"
