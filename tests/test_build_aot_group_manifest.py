...
from video_proxy.data.pipelines.proxy_construction.event_progression.build_progression_manifests import (
    MANIFEST_ACTION,
    MANIFEST_EVENT,
    MANIFEST_EVENT_DIR,
...
def test_cli_resolves_nested_annotation_source_and_meta(tmp_path: Path):
    ...
    subprocess.run(
        [
            sys.executable,
            "video_proxy/data/pipelines/proxy_construction/event_progression/build_progression_manifests.py",
            "--annotation-dir",
            str(ann_dir),
            "--action-output",
            str(action_out),
