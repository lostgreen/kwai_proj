...
from video_proxy.experiments.comparisons.opd.merge_mopd_checkpoints import (
    Checkpoint,
    build_registry,
...
def test_merge_checkpoint_calls_model_merger_even_when_hf_dir_exists(tmp_path: Path):
    ...
    with patch("video_proxy.experiments.comparisons.opd.merge_mopd_checkpoints.subprocess.run") as run:
