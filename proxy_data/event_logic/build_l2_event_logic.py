...
数据来源:
    proxy_data/youcook2_seg_annotation/annotations/{clip_key}.json
...
用法:
    python proxy_data/event_logic/build_l2_event_logic.py \\
        ...
        --clips-dir        /m2v_intern/xuboshen/zgw/data/youcook2_seg_annotation/clips/L2 \\
...
def main():
    ...
    parser.add_argument("--annotation-dir", "-a", required=True,
                        help="L2 标注 JSON 目录 (youcook2_seg_annotation/annotations)")
    parser.add_argument("--clips-dir", required=True,
                        help="L2 clips 目录 (youcook2_seg_annotation/clips/L2)")
    parser.add_argument("--frames-dir", required=True,
                        help="帧目录 (youcook2_seg_annotation/frames)，用于 AI 过滤")
