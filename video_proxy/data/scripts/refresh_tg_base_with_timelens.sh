...
TIMELENS_ROLLOUT_DIR="${TIMELENS_ROLLOUT_DIR:-${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8}"
...
TIMERFT_SOURCE="${TIMERFT_SOURCE:-${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/data/tg_timerft_max256s_validated.jsonl}"
TVGBENCH_SOURCE="${TVGBENCH_SOURCE:-${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/data/tg_tvgbench_max256s_validated.jsonl}"
TG_REFRESH_DIR="${TG_REFRESH_DIR:-${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/data/timelens_refresh_${TAG}}"

SELECT_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/timelens_rollout/select_tg_iou_range.py"
ANALYZE_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/timelens_rollout/analyze_tg_rollout.py"
REWRITE_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/rewrite_tg_prompt_format.py"
MERGE_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/merge_tg_train_with_timelens.py"
CHECK_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/check_tg_prompt_format.py"
