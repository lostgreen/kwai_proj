...
TIMELENS_ROLLOUT_DIR="${TIMELENS_ROLLOUT_DIR:-${REPO_ROOT}/video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8}"
...
TIMERFT_SOURCE="${TIMERFT_SOURCE:-${REPO_ROOT}/video_proxy/data/base_sources/tg/data/tg_timerft_max256s_validated.jsonl}"
TVGBENCH_SOURCE="${TVGBENCH_SOURCE:-${REPO_ROOT}/video_proxy/data/base_sources/tg/data/tg_tvgbench_max256s_validated.jsonl}"
TG_REFRESH_DIR="${TG_REFRESH_DIR:-${REPO_ROOT}/video_proxy/data/base_sources/tg/data/timelens_refresh_${TAG}}"

SELECT_SCRIPT="${REPO_ROOT}/video_proxy/data/base_sources/tg/timelens/select_iou_range.py"
ANALYZE_SCRIPT="${REPO_ROOT}/video_proxy/data/base_sources/tg/timelens/analyze_rollout.py"
REWRITE_SCRIPT="${REPO_ROOT}/video_proxy/data/base_sources/tg/rewrite_format.py"
MERGE_SCRIPT="${REPO_ROOT}/video_proxy/data/base_sources/tg/timelens/merge_with_time_r1.py"
CHECK_SCRIPT="${REPO_ROOT}/video_proxy/data/base_sources/tg/check_format.py"
