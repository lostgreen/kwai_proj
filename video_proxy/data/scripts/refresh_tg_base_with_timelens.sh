...
TIMELENS_ROLLOUT_DIR="${TIMELENS_ROLLOUT_DIR:-${REPO_ROOT}/video_proxy/data/pipelines/data_curation/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8}"
...
SELECT_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/data_curation/timelens_100k/select_tg_iou_range.py"
ANALYZE_SCRIPT="${REPO_ROOT}/video_proxy/data/pipelines/data_curation/timelens_100k/analyze_tg_rollout.py"
