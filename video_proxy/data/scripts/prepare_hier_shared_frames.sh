...
python3 "${REPO_ROOT}/video_proxy/data/mixing/build_source_frame_cache.py" "${BUILD_ARGS[@]}"

python3 "${REPO_ROOT}/video_proxy/data/mixing/rewrite_hier_to_shared_frames.py" "${ARGS[@]}"
