...
Usage from train/:
    python video_proxy/data/base_sources/tg/timelens/analyze_rollout.py \
        --report video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/rollout_report.jsonl \
        --input-jsonl video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/tg_rollout_input.jsonl \
        --output-dir video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/analysis

    # If final merge failed, analyze shard reports directly:
    python video_proxy/data/base_sources/tg/timelens/analyze_rollout.py \
        --report-glob 'video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/_shard*_report.jsonl' \
        --input-jsonl video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/tg_rollout_input.jsonl \
        --output-dir video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/analysis
"""
