...
The prompt/answer style is aligned with video_proxy/data/base_sources/tg/time_r1/build_dataset.py.

Usage:
    python video_proxy/data/base_sources/tg/timelens/build_rollout_dataset.py \
        --input video_proxy/data/base_sources/tg/results/timelens_100k_short/short_pool_raw.jsonl \
        --output video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_input.jsonl \
