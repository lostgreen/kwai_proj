...
Usage from train/:
    python video_proxy/data/base_sources/tg/timelens/select_iou_range.py \
        ...
        --query-stats video_proxy/data/base_sources/tg/results/timelens_100k_short/tg_rollout_qwen3_vl_8b_roll8/analysis/query_stats.jsonl \
        --output-jsonl video_proxy/data/base_sources/tg/data/tg_timelens_iou0p1_0p4.jsonl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--query-stats", required=True, help="analysis/query_stats.jsonl produced by analyze_rollout.py")
