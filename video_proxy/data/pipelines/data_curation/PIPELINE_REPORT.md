...
```
video_proxy/data/pipelines/data_curation/
...
```bash
python video_proxy/data/pipelines/data_curation/et_instruct_164k/stage_a_coarse_filter.py \
    --input video_proxy/data/pipelines/data_curation/results/et_instruct_164k/passed.jsonl \
    --output video_proxy/data/pipelines/data_curation/results/et_instruct_164k/stage_a_results.jsonl \
...
```bash
python video_proxy/data/pipelines/data_curation/shared/vision_filter.py \
    --input video_proxy/data/pipelines/data_curation/results/et_instruct_164k/stage_a_results_keep.jsonl \
    --output video_proxy/data/pipelines/data_curation/results/et_instruct_164k/vision_results.jsonl \
...
```bash
python video_proxy/data/pipelines/data_curation/timelens_100k/stage_a_coarse_filter.py \
    --input video_proxy/data/pipelines/data_curation/results/timelens_100k/passed_timelens.jsonl \
    --output video_proxy/data/pipelines/data_curation/results/timelens_100k/stage_a_results.jsonl \
    --sample-n 1000 --workers 16
```
...
```bash
python video_proxy/data/pipelines/data_curation/shared/vision_filter.py \
    --input video_proxy/data/pipelines/data_curation/results/timelens_100k/stage_a_results_keep.jsonl \
    --output video_proxy/data/pipelines/data_curation/results/timelens_100k/vision_results.jsonl \
...
```bash
cd video_proxy/data/pipelines/data_curation/timelens_100k
...
```bash
python video_proxy/data/pipelines/data_curation/shared/analyze_results.py \
    --input video_proxy/data/pipelines/data_curation/results/et_instruct_164k/stage_a_results.jsonl \
    --stage A --review 3 \
    --html video_proxy/data/pipelines/data_curation/results/et_instruct_164k/stage_a_report.html
```
