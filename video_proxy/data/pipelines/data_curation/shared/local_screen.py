...
Usage (from train/ directory):
    ...
    python video_proxy/data/pipelines/data_curation/shared/local_screen.py \
        --input_jsonl video_proxy/data/pipelines/data_curation/results/et_instruct_164k/sample_dev.jsonl \
    ...
    for i in 0 1; do
        CUDA_VISIBLE_DEVICES=$i python video_proxy/data/pipelines/data_curation/shared/local_screen.py \
