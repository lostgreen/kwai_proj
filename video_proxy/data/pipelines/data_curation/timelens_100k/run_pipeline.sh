...
#
# 用法 (从 train/ 目录运行):
#   bash video_proxy/data/pipelines/data_curation/timelens_100k/run_pipeline.sh
#   LOCAL_MODEL=/m2v_intern/xuboshen/zgw/models/Qwen3-VL-32B-Instruct TP_SIZE=2 \
#     bash video_proxy/data/pipelines/data_curation/timelens_100k/run_pipeline.sh
#   FORCE=1 bash video_proxy/data/pipelines/data_curation/timelens_100k/run_pipeline.sh
#
# 环境变量:
