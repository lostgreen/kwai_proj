...
# ── 默认参数 ────────────────────────────────────────────────────
TIMERFT_JSON="${TIMERFT_JSON:-${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/data/train_2k5.json}"
TVGBENCH_JSON="${TVGBENCH_JSON:-${REPO_ROOT}/video_proxy/data/pipelines/temporal_grounding/data/tvgbench.json}"
