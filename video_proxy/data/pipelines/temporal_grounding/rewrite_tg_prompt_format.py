...
Usage from train/:
    python video_proxy/data/pipelines/temporal_grounding/rewrite_tg_prompt_format.py \
        --input video_proxy/data/pipelines/temporal_grounding/data/tg_timerft_max256s_validated.jsonl \
        --output video_proxy/data/pipelines/temporal_grounding/data/tg_timerft_max256s_validated_reprompt.jsonl
"""
...
from video_proxy.data.pipelines.temporal_grounding.build_dataset import (  # noqa: E402
    PROMPT_TEMPLATE_COT,
