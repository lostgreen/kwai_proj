...
Example:
python video_proxy/data/pipelines/temporal_aot/mix_aot_with_youcook2.py \
  --seg-jsonl video_proxy/data/pipelines/youcook2_train_easyr1.jsonl \
  --v2t-jsonl video_proxy/data/pipelines/temporal_aot/data/v2t_train.jsonl \
  --t2v-jsonl video_proxy/data/pipelines/temporal_aot/data/t2v_train.jsonl \
  --train-output video_proxy/data/pipelines/temporal_aot/data/mixed_aot_train.jsonl \
  --val-output video_proxy/data/pipelines/temporal_aot/data/mixed_aot_val.jsonl
"""
