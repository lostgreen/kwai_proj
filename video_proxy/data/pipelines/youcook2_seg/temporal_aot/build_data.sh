...
#   bash video_proxy/data/pipelines/youcook2_seg/temporal_aot/build_data.sh
#
#   # 跳过切 clips (已切好)
#   SKIP_CLIPS=true bash video_proxy/data/pipelines/youcook2_seg/temporal_aot/build_data.sh
#
#   # 自定义参数
