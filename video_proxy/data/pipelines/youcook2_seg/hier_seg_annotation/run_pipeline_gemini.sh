...
#   bash video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/run_pipeline_gemini.sh
#
# Test mode:
#   LIMIT=3 bash video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/run_pipeline_gemini.sh
#
# Skip frame extraction (if already done):
#   SKIP_FRAMES=1 bash video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/run_pipeline_gemini.sh
#
# With native API key instead of Vertex AI:
#   AUTH_MODE=apikey GEMINI_API_KEY=xxx bash video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/run_pipeline_gemini.sh
#
