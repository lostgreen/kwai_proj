...
Prerequisites:
    ...
    python video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/extract_frames.py \
...
Usage:
    # Classify + visualize
    python video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/stage1_classify.py \
        --jsonl screen_keep.jsonl \
