...
# Usage:
#   tmux new -s anno
#   bash video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/run_pipeline.sh
#   # Ctrl-B D to detach
#
# Test mode (process only N clips):
#   LIMIT=5 bash video_proxy/data/pipelines/youcook2_seg/hier_seg_annotation/run_pipeline.sh
#
