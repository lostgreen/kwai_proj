...
#   bash video_proxy/data/pipelines/youcook2_seg/event_logic/run_event_logic_vlm.sh
#
#   # Test mode (5 annotations, predict_next only)
#   LIMIT=5 TASKS="predict_next" bash video_proxy/data/pipelines/youcook2_seg/event_logic/run_event_logic_vlm.sh
#
#   # Skip clip cutting (already done), only run question generation
#   SKIP_CLIPS=1 bash video_proxy/data/pipelines/youcook2_seg/event_logic/run_event_logic_vlm.sh
#
#   # Dry-run (build script texts only, no API calls, no clip cutting)
#   DRY_RUN=1 LIMIT=10 bash video_proxy/data/pipelines/youcook2_seg/event_logic/run_event_logic_vlm.sh
#
...
# ── Config ──────────────────────────────────────────────────────────
SCRIPT_DIR="video_proxy/data/pipelines/youcook2_seg/event_logic"
CLIP_SCRIPT="video_proxy/data/pipelines/youcook2_seg/prepare_all_clips.py"
