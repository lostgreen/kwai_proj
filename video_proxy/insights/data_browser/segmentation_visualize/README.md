...
bash video_proxy/insights/data_browser/segmentation_visualize/run.sh
 ...
 DATA_PATH=/home/xuboshen/zgw/EasyR1/video_proxy/data/pipelines/hier_seg_annotation/datasets/youcook2_hier_L3_train_clipped.jsonl   PORT=8890   MAX_SAMPLES=100   bash video_proxy/insights/data_browser/segmentation_visualize/run.sh
```
...
```text
video_proxy/data/pipelines/hier_seg_annotation/annotations
```
...
```text
video_proxy/data/pipelines/hier_seg_annotation/youcook2_hier_L3_train.jsonl
```
