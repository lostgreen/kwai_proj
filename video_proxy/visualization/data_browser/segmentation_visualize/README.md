...
```bash
bash video_proxy/visualization/data_browser/segmentation_visualize/run.sh
```
...
bash video_proxy/visualization/data_browser/segmentation_visualize/run.sh
 ...
 DATA_PATH=/home/xuboshen/zgw/EasyR1/video_proxy/data/pipelines/hier_seg_annotation/datasets/youcook2_hier_L3_train_clipped.jsonl   PORT=8890   MAX_SAMPLES=100   bash video_proxy/visualization/data_browser/segmentation_visualize/run.sh
```

或手动启动：

```bash
python video_proxy/visualization/data_browser/segmentation_visualize/server.py \
  --host 127.0.0.1 \
  --port 8890 \
  --static-dir video_proxy/visualization/data_browser/segmentation_visualize \
