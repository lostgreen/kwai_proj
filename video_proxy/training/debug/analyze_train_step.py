...
WATCH_KEYS = (
    ...
    "reward/response_loss_weight/thought_token_ratio",
    "reward/response_loss_weight/answer_token_ratio",
    "reward/response_loss_weight/thought_effective_ratio",
    "reward/response_loss_weight/answer_effective_ratio",
    "reward/response_loss_weight/weighted_token_ratio",
    "actor/loss_weight_mask_present",
    "actor/loss_weight_mean",
    "actor/loss_weight_changed_ratio",
    "val/reward_score",
    "val/overall_reward",
    "val/temporal_grounding/overall_reward",
    "val/temporal_grounding/accuracy_reward",
    "val/temporal_grounding/count",
    "val/temporal_seg_hier_L1/overall_reward",
    "val/temporal_seg_hier_L2/overall_reward",
    "val/temporal_seg_hier_L3_seg/overall_reward",
    "val/llava_mcq/overall_reward",
