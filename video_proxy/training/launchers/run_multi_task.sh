...
echo "[multi-task] ACTOR_LOSS_AVG_MODE=${ACTOR_LOSS_AVG_MODE} ENABLE_RESPONSE_LOSS_WEIGHT_MASK=${ENABLE_RESPONSE_LOSS_WEIGHT_MASK} THOUGHT_LOSS_WEIGHT=${THOUGHT_LOSS_WEIGHT} ANSWER_LOSS_WEIGHT=${ANSWER_LOSS_WEIGHT} DEFAULT_LOSS_WEIGHT=${DEFAULT_LOSS_WEIGHT} ANSWER_FALLBACK_AFTER_THOUGHT=${ANSWER_FALLBACK_AFTER_THOUGHT}"
