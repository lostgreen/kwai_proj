...
if [[ "${COT_MODE,,}" =~ ^(true|1|yes)$ ]]; then
    ...
    COT_BUDGET_REPAIR_SUFFIX="${COT_BUDGET_REPAIR_SUFFIX:-<answer>}"
...
export COT_BUDGET_REPAIR_SUFFIX
export ENABLE_RESPONSE_LOSS_WEIGHT_MASK THOUGHT_LOSS_WEIGHT ANSWER_LOSS_WEIGHT DEFAULT_LOSS_WEIGHT FORMAT_LOSS_WEIGHT ANSWER_FALLBACK_AFTER_THOUGHT
export VLLM_USE_V1
