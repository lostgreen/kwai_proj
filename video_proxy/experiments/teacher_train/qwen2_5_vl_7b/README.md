...
```bash
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_debug_2gpu.sh aot_nocot
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_train_8gpu.sh aot_nocot
```
...
```bash
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_aot_nocot.sh
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_aot_cot.sh
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_seg_nocot.sh
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_seg_cot.sh
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_logic_nocot.sh
bash video_proxy/experiments/teacher_train/qwen2_5_vl_7b/run_logic_cot.sh
```
