...
```bash
bash video_proxy/experiments/teacher_train/qwen3_vl_8b/run_debug_2gpu.sh aot_nocot
bash video_proxy/experiments/teacher_train/qwen3_vl_8b/run_train_8gpu.sh aot_nocot
```
