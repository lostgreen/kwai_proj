...
```bash
bash video_proxy/experiments/comparisons/opd/run_mopd_8b_from_4b_teachers.sh
```

Run the 4B full-data EMA-GRPO rerun:

```bash
bash video_proxy/experiments/comparisons/opd/run_grpo_4b_full_epoch.sh
```

Run the 4B full-data MOPD setting:

```bash
bash video_proxy/experiments/comparisons/opd/run_mopd_4b_full_epoch.sh
```

Run the 4B base+R1/R2 MOPD setting:

```bash
bash video_proxy/experiments/comparisons/opd/run_mopd_4b_base_r1_r2.sh
```
