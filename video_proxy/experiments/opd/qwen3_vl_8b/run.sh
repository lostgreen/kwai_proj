...
EXP_NAME="${EXP_NAME:-qwen3_vl_8b_opd}"
TEACHER_MODEL_PATH="${TEACHER_MODEL_PATH:-/m2v_intern/xuboshen/zgw/RL-Models/VideoProxyMixed/multi_task/qwen3_vl_8b_teacher_ema_grpo/global_step_200/actor/huggingface}"
