#!/usr/bin/env bash
# Qwen2.5-VL-7B full-composition MOPD with task-specific AOT/SEG/event-logic teachers.
set -euo pipefail
...
EXP_NAME="${EXP_NAME:-mopd_qwen2_5vl7b_full_comp_3teachers_bs64_mf256_epoch1_save50_keep1}"
...
EVENTLOGIC_TEACHER_MODEL_PATH="${EVENTLOGIC_TEACHER_MODEL_PATH:-/m2v_intern/xuboshen/zgw/RL-Models/VideoProxyMixed/multi_task/qwen2_5_vl_7b_logic_teacher_nocot/global_step_250/actor/huggingface}"
